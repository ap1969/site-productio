# Build process
1. Edit content via https://si-e033e.sanity.studio/
2. Sanity pushes webhook to GET url on pipedream
3. Pipedream triggers POST request to gitlab to trigger build.
...
The content of this site is managed by Sanity.io. Visit https://si-e033e.sanity.studio/ to manage site content
